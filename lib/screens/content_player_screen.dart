...
class _State extends State<ContentPlayerScreen> {
  ...
  Widget _buildPlayer() => Stack(children: [
        ...
        Positioned(bottom:16,left:16,right:16,child:ValueListenableBuilder(
          ...
          builder:(ctx,val,_){
            ...
            return Column(mainAxisSize:MainAxisSize.min,children:[
              Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children:[Text(fmt(pos),style:const TextStyle(color:Colors.white,fontSize:12)),Text(fmt(dur),style:const TextStyle(color:Colors.white,fontSize:12))]),
